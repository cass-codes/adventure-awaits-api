...
export const screens: Record<string, Screen> = {
  [visitTheBlacksmith._id]: visitTheBlacksmith,
  [buyTheShield._id]: buyTheShield,
  [haggleSuccess_shield._id]: haggleSuccess_shield,
  [haggleFail_shield._id]: haggleFail_shield,
  [buyItOutRight_shield._id]: buyItOutRight_shield,
  [buyTheArmor._id]: buyTheArmor,
  [haggleSuccess_armor._id]: haggleSuccess_armor,
  [paymentPlan_armor._id]: paymentPlan_armor,
  [paymentPlanAccepted_armor._id]: paymentPlanAccepted_armor,
  [haggleFail_armor._id]: haggleFail_armor,
  [buyItOutRight_armor._id]: buyItOutRight_armor,
  [buyTheSword._id]: buyTheSword,
  [buyItOutRight_sword._id]: buyItOutRight_sword,
  [whatsForSale_blacksmith._id]: whatsForSale_blacksmith,
  [haggleSuccess_sword._id]: haggleSuccess_sword,
  [haggleFail_sword._id]: haggleFail_sword,
};
