...
export const findAnInnScreens: Record<string, Screen> = {
  [theAdventureBegins._id]: theAdventureBegins,
  [rustySword_1._id]: rustySword_1,
  [silverSpoon1._id]: silverSpoon1,
  [sewerWater1._id]: sewerWater1,
  [joinTheFestivities._id]: joinTheFestivities,
  [winArmWrestle._id]: winArmWrestle,
  [callItANight._id]: callItANight,
  [seekSolitude._id]: seekSolitude,
  [stepInToHelp_success._id]: stepInToHelp_success,
  [approachFigure._id]: approachFigure,
  [loseArmWrestle._id]: loseArmWrestle,
  [lookForWork._id]: lookForWork,
  [tryingToSeeTheWorld._id]: tryingToSeeTheWorld,
  [runningAwayFromSomething._id]: runningAwayFromSomething,
  [thankTheDruid_callItANight._id]: thankTheDruid_callItANight,
  [callItANight_SS._id]: callItANight_SS,
  [findTable._id]: findTable,
  [eavesdrop._id]: eavesdrop,
  [callItANight_SW._id]: callItANight_SW,
  [intervene._id]: intervene,
  [defuseSituation_success._id]: defuseSituation_success,
  [defuseSituation_failure._id]: defuseSituation_failure,
  [findDifferentInn._id]: findDifferentInn,
  [middleOfBrawl._id]: middleOfBrawl,
  [followHimInside._id]: followHimInside,
  [thankTheMan_callItANight._id]: thankTheMan_callItANight,
  [lookingToDisappear._id]: lookingToDisappear,
  [SW_tryingToSeeTheWorld._id]: SW_tryingToSeeTheWorld,
  [lookingForAnswers._id]: lookingForAnswers,
  [aggressive._id]: aggressive,
  [keepALowProfile._id]: keepALowProfile,
  [observe._id]: observe,
  [tryingToMakeMoney._id]: tryingToMakeMoney,
  [tryingToProveMyself._id]: tryingToProveMyself,
  [tryingToGetRevenge._id]: tryingToGetRevenge,
  [thankTheKnight_callItANight._id]: thankTheKnight_callItANight,
  [tryToProveYourself._id]: tryToProveYourself,
  [yesToWorkingTogether._id]: yesToWorkingTogether,
  [failedAtHelping._id]: failedAtHelping,
  [tryToSeeTheWorld_somerild._id]: tryToSeeTheWorld_somerild,
  [lookForWork_somerild._id]: lookForWork_somerild,
  [theLuteIsMyFavorite._id]: theLuteIsMyFavorite,
  [thankTheBard_callItANight._id]: thankTheBard_callItANight,
  [bard_lookingForWork._id]: bard_lookingForWork,
  [noThanks_Serena._id]: noThanks_Serena,
  [bard_lookingForTroupe._id]: bard_lookingForTroupe,
  [bard_runningAway._id]: bard_runningAway,
  [IJustSing._id]: IJustSing,
  [ITellTales._id]: ITellTales,
  [playASong_success._id]: playASong_success,
  [askedToPlay._id]: askedToPlay,
  [joinTheFestivities_bard._id]: joinTheFestivities_bard,
  [playASong_failure._id]: playASong_failure,
  [notMuchOfAPerformer._id]: notMuchOfAPerformer,
  [bard_learning._id]: bard_learning,
};
